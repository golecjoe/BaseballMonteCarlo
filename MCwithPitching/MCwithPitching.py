...
#K, BF, LgAvg K/BF
HomePitcher = np.empty([3],float)
AwayPitcher = np.empty([3],float)
#Justin Verlander 6/26/2016
HomePitcher[0] = 5
HomePitcher[1] = 24
HomePitcher[2] = 0.211
#Corey Kluber 2016
...
HomeKfactor = (HomePitcher[0]/HomePitcher[1])-HomePitcher[2]
AwayKfactor = (AwayPitcher[0]/AwayPitcher[1])-AwayPitcher[2]

Homeprobs[2:7] = Homeprobs[2:7] - AwayKfactor/5
Homeprobs[8] = Homeprobs[8] + AwayKfactor
Awayprobs[2:7] = Awayprobs[2:7] - HomeKfactor/5
Awayprobs[8] = Awayprobs[8] + HomeKfactor
###########################################
